...
export const experiencesData = [
  {
    ...
    location: "Capgemini",
    description: [
      "Recognized with the GEM (Going the Extra Mile) Award for demonstrating leadership in setting up the project infrastructure, mentoring 3 engineers and improving sprint velocity.",
      "Recognized with the WOW Award for upgrading 3 legacy codebases, implementing 2 security enhancements, and collaborating across 3 teams.",
