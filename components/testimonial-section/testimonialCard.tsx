...
export default function TestimonialCard({
  ...
  return (
    <div className="rounded-2xl shadow-md bg-white dark:bg-gray-800 p-6 h-full flex flex-col justify-between transition-transform duration-300 hover:scale-[1.02]">
      {/* Top: Reviewer Info */}
