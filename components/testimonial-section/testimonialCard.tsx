...
export default function TestimonialCard({
  ...
  return (
    <div className="borderBlack rounded-xl shadow-none h-[15rem] md:h-[17rem] p-4 bg-[#f3f4f6] dark:bg-gray-800">
      ...
      <div className="testimonial_card_body">
        <p className="testimonial_comment italic text-sm text-gray-700 dark:text-gray-300">
          &quot;{review}&quot;
        </p>
      </div>
    </div>
